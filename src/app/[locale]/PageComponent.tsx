        ...
        <div className="block overflow-hidden bg-[#020d24] bg-cover bg-center text-white"
          ...
          <div className="mx-auto w-full max-w-7xl px-5 mb-5">
            <div
              ...
              <a
                href="https://www.producthunt.com/posts/sorawithvideos?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-sorawithvideos"
                target="_blank"><img
                src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=440945&theme=light"
                alt="sorawithvideos - Open&#0045;source&#0032;Sora&#0032;Web&#0032;Client | Product Hunt"
              /></a>
            </div>
            <div>
              <div
            ...
            <div className={"border-[14px] border-[#ffffff1f] object-fill w-[90%] mx-auto mt-8"}>
              <div className={"mx-auto bg-white py-8"}>
                ...
                <div className={"w-[96%] text-gray-700 prose mx-auto mt-4"}>
                  ...
                  <p>
                    {questionText.h2_2_p4a}<Link href={"https://sorawithvideos.com/"}
                                                 className={"text-blue-500"}>https://sorawithvideos.com/</Link>{questionText.h2_2_p4b}<Link
                    href={"https://github.com/sorawithvideos/sorawithvideos"}
                    className={"text-blue-500"}>https://github.com/sorawithvideos/sorawithvideos</Link>.
                  </p>
                </div>
              </div>
            </div>
